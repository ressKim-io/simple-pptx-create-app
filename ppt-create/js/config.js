...
//
// dw/sx 는 '4:3 와이드' 전용 — 4:3(dw 폭)으로 짠 화면을 좌우로만 sx배 늘려 16:9(w 폭)로
// 내보낸다. 4:3 화면에 꽉 채워 띄우면 좌우가 도로 눌려 원래 4:3 모양이 된다.
// 세로는 건드리지 않으므로 글자 크기·줄 간격은 4:3 때와 같은 값을 쓴다.
export var RATIOS = {
  '16:9': { w: 1920, h: 1080, inW: 13.333, inH: 7.5 },
  '4:3':  { w: 1440, h: 1080, inW: 10,     inH: 7.5 },
  '4:3w': {
    w: 1920, h: 1080, inW: 13.333, inH: 7.5, dw: 1440, sx: 4 / 3,
    label: '4:3 와이드',
    note: '4:3으로 짠 화면을 좌우로 늘려 16:9로 저장해요. 4:3 화면에 꽉 채워 띄우면 원래 4:3 모양으로 보입니다. '
        + '(PPTX에는 글자가 그림으로 들어가요 — 파워포인트가 글자를 가로로만 늘리지 못해서예요. 대신 거기서 글자 수정은 안 돼요.)'
  },
...
export var PVW = {
  ...
  '4:3w': 'min(660px, 96cqw, calc(90cqh * 16 / 9))',
  '1:1':  'min(480px, 96cqw, 90cqh)'
};
export var PV_ASPECT = { '16:9': '16 / 9', '4:3': '4 / 3', '4:3w': '16 / 9', '1:1': '1 / 1' };
// cqh를 cqw 단위로 환산한 값(높이÷너비) — 4:3 와이드는 '짜는 화면'이 4:3이라 4:3과 같다
export var RF = { '16:9': 0.5625, '4:3': 0.75, '4:3w': 0.75, '1:1': 1 };
